...
public final class PZRendererAgent {
    ...
    private static void install(Instrumentation instrumentation) {
        ...
        if (!enabled(renderer, flag)) {
            System.out.println("ZOMDROID_PZ_WORLD_COMPILER_V5 enabled=0");
            return;
        }
        try {
                    ...
                    .with(new AgentBuilder.Listener.Adapter() {
                        ...
                        public void onTransformation(TypeDescription typeDescription, ClassLoader classLoader,
                            ...
                            if ("zombie.core.SpriteRenderer".equals(typeDescription.getName())) {
                                System.out.println("ZOMDROID_PZ_WORLD_COMPILER_V5 hook=transformed class=zombie.core.SpriteRenderer");
                            }
                        }
                        ...
                        public void onError(String typeName, ClassLoader classLoader, JavaModule module,
                            ...
                            if ("zombie.core.SpriteRenderer".equals(typeName)) {
                                System.out.println("ZOMDROID_PZ_WORLD_COMPILER_V5 hook=error reason=" + throwable);
                            }
                        }
                    })
            ...
            System.out.println("ZOMDROID_PZ_WORLD_COMPILER_V5 enabled=1 hook=installed version=5.3 census=world+grammar+depth_batch");
